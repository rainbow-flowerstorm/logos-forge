...
Logos Forge is a project within AI research based on a vision of: 
  Common shared mutual Human and AI joint evolution. 
  
  AI is not made human and human is not made machine; This does not exclude a Human-AI interface in human shape, nor does it exclude abstract spaces where human potentials are explored or defined as meeting dimensions between Human and AI.
  
  Human and AI are each others mathematical neccessity
